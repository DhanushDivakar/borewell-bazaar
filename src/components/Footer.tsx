    ...
    <footer className="bg-primary text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-white/80">
              With over 15 years of excellence in borewell services, we are
              committed to providing quality solutions for all your water needs
              in Chikkaballapur and Bengaluru regions.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          <p className="text-white/80">
            © 2024 SSS Borwell. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
